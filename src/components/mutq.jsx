...
function Mutq({ setActiveTab }) {
  ...
  return (
    <div className="w-full min-h-screen bg-[#f4f7f6] flex flex-col justify-between font-sans select-none relative">
          ...
          <div className="w-full max-w-xl bg-white rounded-xl shadow-sm border border-gray-200/80 p-8 sm:p-10 flex flex-col items-center">
            ...
            <div className="mb-8">
              <button 
                ...
                className="text-xs text-neutral-600 hover:text-[#6400dc] transition-colors bg-transparent border-0 cursor-pointer"
              >
                {currentT.forgot}
              </button>
            </div>
      ...
      <footer className="w-full px-8 py-4 flex flex-col md:flex-row justify-between items-center text-[11px] text-gray-500 gap-4 bg-transparent">
        ...
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-1.5 text-neutral-700 font-medium">
            ...
            <a href="tel:+37410605555" className="hover:text-[#6400dc] transition-colors">{currentT.phone}</a>
          </div>
          <div className="flex items-center gap-1.5 text-neutral-700 font-medium">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-3.5 text-neutral-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
            </svg>
            <a href="mailto:hello@evoca.am" className="hover:text-[#6400dc] transition-colors">{currentT.email}</a>
          </div>
        </div>
