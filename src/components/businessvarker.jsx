...
function BusinessVarker({ setActiveTab }) {
  const businessLoans = [
    {
      id: 1,
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="max-w-7xl mx-auto w-full px-6 lg:px-8 pt-4 text-xs text-gray-400 flex items-center gap-2">
        <span 
        ...
        <span>&gt;</span> 
        <span className="text-gray-600 font-medium">Բիզնես վարկեր</span>
      </div>

      {/* Բիզնես վարկեր վերնագրի հատված */}
      <div className="bg-[#6400dc] text-white py-6 px-6 lg:px-16 mt-4">
        <h1 className="text-3xl lg:text-4xl font-extrabold max-w-7xl mx-auto">Բիզնես վարկեր</h1>
      </div>
