...
// Դու պետք է օգտագործես թափանցիկ ֆոնով արձանի նկարը, որը ես քեզ տվեցի նախորդ քայլերում
// Կամ օգտագործիր բնօրինակի ուղիղ հղումը, եթե այն աշխատում է
...
function BestEvocabankSection() {
  return (
    <section className="relative bg-[#6400DC] py-20 lg:py-28 overflow-hidden text-white">
      
      {/* Ֆոնային դեկորատիվ տարրեր (փոքր երկրաչափական պատկերներ) */}
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 relative z-10">
        ...
        {/* Հիմնական բովանդակություն՝ Արձանը ձախում, Տեքստը կենտրոնում, Քարտերը աջում */}
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-12">
          ...
          <div className="w-full lg:w-5/12 flex justify-center items-center relative h-[500px] order-2 lg:order-1 mt-10 lg:mt-0">
            <div className="relative flex justify-center items-center w-full h-full">
              ...
              {/* Մանուշակագույն ետնամասի կոր ձևը */}
              <div 
