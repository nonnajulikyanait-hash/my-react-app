          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
              <button 
                ...
                className="w-full px-6 py-4 text-left font-semibold text-neutral-800 flex justify-between items-center bg-white hover:bg-gray-50 cursor-pointer"
              >
                <span>Ուշադրություն.</span>
                <span className={`transform transition-transform ${openAccordion === 1 ? 'rotate-180' : ''}`}>▼</span>
              </button>
              {openAccordion === 1 && (
                <div className="px-6 pb-6 text-gray-700 text-sm space-y-3 border-t border-gray-100 pt-4 leading-relaxed">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
              ...
              >
                ...
                <span className={`transform transition-transform ${openAccordion === 2 ? 'rotate-180' : ''}`}>▼</span>
              </button>
              {openAccordion === 2 && (
                <div className="px-6 pb-6 text-gray-700 text-sm space-y-3 border-t border-gray-100 pt-4 leading-relaxed">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
              ...
              >
                ...
                <span className={`transform transition-transform ${openAccordion === 3 ? 'rotate-180' : ''}`}>▼</span>
              </button>
              {openAccordion === 3 && (
                <div className="px-6 pb-6 text-gray-700 text-sm space-y-3 border-t border-gray-100 pt-4 leading-relaxed">
          ...
          <div className="space-y-3">
            <div className="bg-white p-4 rounded-2xl border border-gray-200 flex items-center justify-between shadow-sm hover:border-purple-300 transition-colors cursor-pointer">
              <div className="flex items-center space-x-4">
                ...
                <span className="font-semibold text-neutral-800 text-sm">Կանոնադրություն</span>
              </div>
            ...
            <div className="bg-white p-4 rounded-2xl border border-gray-200 flex items-center justify-between shadow-sm hover:border-purple-300 transition-colors cursor-pointer">
              <div className="flex items-center space-x-4">
                <span className="text-2xl">📄</span>
                <span className="font-semibold text-neutral-800 text-sm">Բանկային գործունեության լիցենզիա</span>
              </div>
              <span className="text-gray-400">↓</span>
            </div>
            ...
            <div className="bg-white p-4 rounded-2xl border border-gray-200 flex items-center justify-between shadow-sm hover:border-purple-300 transition-colors cursor-pointer">
              <div className="flex items-center space-x-4">
                <span className="text-2xl">📄</span>
                <span className="font-semibold text-neutral-800 text-sm">Բանկի գրանցման վկայականը</span>
              </div>
              <span className="text-gray-400">↓</span>
            </div>
          </div>
