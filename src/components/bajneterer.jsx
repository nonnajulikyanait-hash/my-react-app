        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
              ...
              {openAccordion === 1 && (
                <div className="px-6 pb-6 text-gray-700 text-sm space-y-4 border-t border-gray-100 pt-4 leading-relaxed">
                  <div className="flex items-start space-x-3">
                    <span className="w-2 h-2 rounded-full bg-[#6400dc] mt-2 flex-shrink-0"></span>
