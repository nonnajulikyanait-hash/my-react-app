...
function Harcer({ setActiveTab }) {
  ...
  // Բոլոր բաժինների հարցերը և պատասխանները
  const questionsData = {
    'Պարտատոմսեր': [
      {
    ...
    'Ավանդներ': [
      {
        ...
        a: "Այո, բանկը գործում է 1990 թվականից, և բոլոր ավանդները երաշխավորված են Ավանդների փոխհատուցումը երաշխավորող հիմնադրամի կողմից:"
      },
      {
        q: "Ի՞նչ է ավանդների հատուցումը երաշխավորող հիմնադրամը:",
        a: "Այն հիմնադրամ է, որի նպատակն է ապահովել բանկային համակարգի կայունությունը և երաշխավորել ֆիզիկական անձանց ավանդների վերադարձը:"
      },
      {
        q: "Կարելի՞ է ավանդի գումարն օգտագործել պայմանագրի ժամկետից շուտ:",
        a: "Ժամկետից շուտ ելքագրումը համարվում է պայմանագրի խզում, ինչի հետևանքով կատարվում է տոկոսների վերահաշվարկ:"
      },
      {
        q: "Ի՞նչ է եկամտային հարկը, և որքա՞ն հարկ եմ վճարելու ավանդ ներդնելու դեպքում:",
        a: "Ավանդների դիմաց վճարվող տոկոսագումարից գանձվում է եկամտային հարկ՝ տոկոսագումարի 10%-ի չափով:"
      }
    ],
    'Այլ': [
      {
      ...
      },
      {
        ...
        a: "Evoca Benefits-ը նախագիծ է, որի շրջանակում քարտապանները ստանում են զեղչեր, քեշբեքեր և այլ առավելություններ ավելի քան 100 գործընկերների մոտ:"
      },
      {
        q: "Ինչպե՞ս պատվիրել Evoca քարտ։",
        a: "Քարտ կարող եք պատվիրել evoca.am կայքի կամ EvocaTOUCH հավելվածի միջոցով, ինչպես նաև այցելելով բանկի գրասենյակներ:"
      }
    ]
  };
