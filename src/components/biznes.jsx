...
function Biznes() {
  const businessLoans = [
    ...
    },
    {
      ...
      description: "Сტացեք վարկ՝ Բանկի պարտատոմսերի գրավով և շարունակեք զարգացնել ձեր բիզնեսը:",
    ...
    },
    {
      ...
      description: "Եթե Դանկ ցանկանում եք ձեռք բերել էԱ սարքավորումներ և մեքենաներ կամ իրականացնել այլ էներգաարդյունավետ ներդրումներ, այս վարկատեսակը ձեզ համար է:",
      ...
      stats: [
        {
          ...
          value: "առանց գրավի մինչև 10 մլն. ֏"
        },
        {
          label: "Տարեկան անվանական տոկոսադրույք ՎЕЕК դեպքում (փաստացի տոկոսադրույք մինչև 10%)",
          value: "9.5%"
        },
        {
          label: "Տարեկան անվանական տոկոսադրույք ЕАБ դեպքում (փաստացի տոկոսադրույք մինչև 10.75%)",
          value: "10.25%"
        },
        {
          label: "Մարման ժամկետ (VEEK դեպքում)",
          value: "Մինչև 120 ամիս"
        }
      ]
    },
    {
      ...
      stats: [
        { label: "Սահմանաչափ (կամ համարժեք արտարժույթ)", value: "Մինչև 50 մլն. ֏" },
    ...
    },
    {
      ...
      description: "Հանդիսանում եք Evocabank-ի հաշվետեր հաճախորդ առվազն 1 տարի, ուրեմն Evocabank-ը կօգնի հոգալ ձեր բիզնեսի ընթացիկ ծախսերը:",
    ...
    },
    {
      ...
      stats: [
        { label: "Կամ համարժեք արտարժույթ սահմանաչափ", value: "Մինչև 1 մլրդ ֏" },
        { label: "Մարման ժամկետ", value: "Մինչև 120 ամիս" },
        { label: "Տոկոսադրույք", value: "Սկսած 6%" },
        { label: "Սուբսիդավորում", value: "Մինչև 6%" }
      ]
    },
    {
      id: 14,
